      ...
      <main class="max-w-6xl mx-auto pt-10 pb-36 px-8">
        <div class="max-w-md mx-auto mb-14 text-center">
          <h1 class="text-4xl font-semibold mb-6 lg:text-5xl">
            <span class="text-teal-500">Flexible</span> Plans
          </h1>
        ...
        <div class="flex flex-col justify-between items-center lg:flex-row lg:items-start">
          <div class="w-full flex-1 mt-8 p-8 order-2 bg-white shadow-xl rounded-3xl sm:w-96 lg:w-full lg:order-1 lg:rounded-r-none">
            <div class="mb-7 pb-7 flex items-center border-b border-gray-300">
              ...
              />
              <div class="ml-5">
                <span class="block text-2xl text-black font-semibold">
                  Basic
                </span>
                <span>
                  ...
                  <span class="text-3xl text-black font-bold">10 </span>
                </span>
            ...
            <a
              href="#/"
              class="flex justify-center items-center bg-teal-500 rounded-xl py-5 px-4 text-center text-white text-xl"
            >
              Choose Plan
              <img
          ...
          <div class="w-full flex-1 p-8 order-1 shadow-xl rounded-3xl bg-gray-900 text-gray-400 sm:w-96 lg:w-full lg:order-2 lg:mt-0">
            ...
            <a
              href="#/"
              class="flex justify-center items-center bg-teal-500 rounded-xl py-6 px-4 text-center text-white text-2xl"
            >
              Choose Plan
              <img
                src="https://res.cloudinary.com/williamsondesign/arrow-right.svg"
            ...
            <div class="mb-7 pb-7 flex items-center border-b border-gray-300">
              ...
              <div class="ml-5">
                ...
                <span>
                  ...
                  <span class="text-3xl text-black  font-bold">35 </span>
                </span>
                <span class="text-gray-500 font-medium">/ user</span>
              </div>
            </div>
      ...
      <div class="">
        <div class="container m-auto px-6 py-20 md:px-12 lg:px-20">
          <div class="m-auto text-center lg:w-8/12 xl:w-7/12">
            <h2 class="text-2xl  text-teal-500 font-bold md:text-4xl">
          ...
          <div class="mt-12 m-auto -space-y-4 items-center justify-center md:flex md:space-y-0 md:-space-x-4 xl:w-10/12">
            <div class="relative z-10 -mx-4 group md:w-6/12 md:mx-0 lg:w-5/12">
              ...
              <div class="relative p-6 space-y-6 lg:p-8">
                  ...
                  <div class="relative flex justify-around">
                    <div class="flex items-end">
                      ...
                      <div class="pb-2">
                        ...
                        <span class="block text-xl text-teal-500 font-bold">
                          Off
                        </span>
                      </div>
                    </div>
                ...
                >
                  <li class="space-x-2">
                    <span class="text-teal-500 font-semibold">&check;</span>
                ...
                <p class="flex items-center justify-center space-x-4 text-lg text-gray-600 text-center">
                  ...
                  <a
                    href="tel:+24300"
                    class="flex space-x-2 items-center text-teal-600"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
                ...
                <button
                  type="submit"
                  title="Submit"
                  class="block w-full py-3 px-6 text-center rounded-xl transition bg-teal-500 hover:bg-teal-700 active:bg-teal-800 focus:bg-teal-600"
                >
