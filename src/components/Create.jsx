    ...
    <div>
      {shortLink === null ? (
        <form onSubmit={onSubmitHandler}>
          ...
          <button
            type="submit"
            class="w-full text-white bg-pink-500 mt-5 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
          >
            Submit
          </button>
        </form>
        ...
        <div>
          <div>
            <div className="bg-pink-500 p-1 border rounded-lg inline-block ">
              Shortened URL
            </div>
          </div>
